...
M.config = function()
  ...
  -- =========================================
    ...
    --   lazy = true,
    --   config = function()
    --     require("user.plugins.rust_tools").config()
    --   end,
    --   ft = { "rust", "rs" },
    ...
    },
    {
      ...
      cmd = "ZenMode",
      config = function()
        require("user.plugins.zen").config()
      end,
    },
    {
      "windwp/nvim-spectre",
      lazy = true,
      config = function()
        require("user.plugins.spectre").config()
      end,
    },
    {
    ...
    },
    {
      ...
      lazy = true,
      config = function()
        require("user.plugins.persist").config()
      end,
    ...
    --   config = function()
    --     require("user.plugins.vim_test").config()
    --   end,
    ...
    --   config = function()
    --     require("user.plugins.ntest").config()
    --   end,
    --   dependencies = {
    ...
    --   dependencies = "nvim-lua/plenary.nvim",
    --   config = function()
    --     require("user.plugins.flutter_tools").config()
    --   end,
    --   ft = "dart",
    -- },
    -- {
    ...
    --   config = function()
    --     require("user.plugins.neoclip").config()
    --   end,
    --   lazy = true,
    --   keys = "<leader>y",
    ...
    --   config = function()
    --     require("user.plugins.sidebar").config()
    --   end,
    --   -- event = "BufRead",
    ...
    --   branch = "legacy",
    --   config = function()
    --     require("user.plugins.fidget_spinner").config()
    --   end,
    ...
    --   dependencies = { { "nvim-lua/plenary.nvim" } },
    --   config = function()
    --     require("user.plugins.crates").config()
    --   end,
    --   enabled = lvim.builtin.rust_programming.active,
    -- },
    {
    ...
    },
    {
      "b0o/incline.nvim",
      config = function()
        require("user.plugins.incline").config()
      end,
    ...
    },
    {
      "fgheng/winbar.nvim",
      config = function()
        require("user.plugins.winb").config()
      end,
    ...
    --   config = function()
    --     require("user.plugins.gps").config()
    --   end,
    --   dependencies = "nvim-treesitter/nvim-treesitter",
    --   event = { "InsertEnter", "CursorHoldI" },
    --   enabled = lvim.builtin.winbar_provider == "treesitter",
    ...
    --   },
    --   config = function()
    --     require("user.plugins.neotree").config()
    --   end,
    ...
    --   config = function()
    --     require("user.plugins.cle").cmake_config()
    --   end,
    --   ft = { "c", "cpp", "objc", "objcpp", "h", "hpp" },
    --   enabled = lvim.builtin.cpp_programming.active,
    -- },
